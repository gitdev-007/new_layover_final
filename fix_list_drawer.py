...
def fix_renderListDrawer():
  ...
  window.renderListDrawer = function() {
    ...
    html = re.sub(r'window\.renderListDrawer = function\(\) \{.*?drawer\.innerHTML = html;\n  \};', new_render_func, html, flags=re.DOTALL)

    with codecs.open(filepath, 'w', encoding='utf-8') as f:
        f.write(html)
    print("Updated marketplace.html drawer edit logic.")
